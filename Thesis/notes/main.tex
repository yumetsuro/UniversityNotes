...
\thesistitle{Deep Recurrent Reservoir...etc} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\chapter{Problem Statement and Related works}\label{ch:related}
\input{chapters/relatedworks}

\chapter{Stacking RON Layers}\label{ch:methodology}
