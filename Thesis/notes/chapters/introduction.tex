...
With RC we can solve chaotic time series prediction, speech recognition, robot control \todo{add citation here} with ease with minimal training cost, and we can even use them as a generative model with techniques like Teacher Forcing \cite{6795228}.\newline
